        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class=" br-6">
                <div style='float:right; padding-right:30px'>
                    ...
                    <!-- <button type='button' name='add' id='add_Data' class="btn btn-outline-info mb-2 mr-2 btn-sm">
                        <svg> ... </svg> Add</button> -->
                </div>
                ...
                <div id='entryModalSmall' class='modal fade  register-modal' role='dialog' 
                    ...
                    <div class='modal-dialog modal-dialog-centered modal-lg'role="document">
                            ...
                            <form  id='singleLevelDataEntryForm' autocomplete="off"
                                    method="post" action="{{ route('city.postdata') }}">
                                            ...
                                            <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" 
                                                ...
                                                <div class="container-fluid">
                                                    ...
                                                    <div class='form-group mb-0'>
                                                        <input type="hidden" name='GMCTHUniqueId' id='GMCTHUniqueId' 
                                                            class='form-control'>                                                  
                                                    </div>
                                                    <!-- CopyChange -->
                                                    <div class="row mt-0">
                                                        <div class="col-md-6">
                                                            <div class='form-group '>
                                                                <label>City Id</label> 
                                                                <span class="error-text GMCTHCityId_error text-danger" style='float:right;'></span>
                                                                <input type="text"  name='GMCTHCityId' id='GMCTHCityId' 
                                                                    class='form-control few-options' maxlength="10" placeholder="City Id" style='opacity: 1'>
                                                            </div>
                                                        </div>
                                                        <!-- CopyChange -->
                                                        <div class="col-md-6">
                                                            <div class='form-group '>
                                                                ...
                                                                <span class="error-text GMCTHDesc1_error text-danger" style='float:right;'></span>
                                                                <input type="text" name='GMCTHDesc1' id='GMCTHDesc1' 
                                                                    class='form-control few-options' maxlength="100" placeholder="City Description">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- CopyChange -->
                                                    <div class="row mt-0">
                                                        <div class="col-md-6">
                                                            <div class='form-group '>
                                                                ...
                                                                <textarea name='GMCTHDesc2' id='GMCTHDesc2' class='form-control few-options' 
                                                                    maxlength="200" name="alloptions" id="alloptions1" placeholder="City Description2" 
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class='form-group '>
                                                                <label>BI Desc</label>
                                                                <input type="text" name='GMCTHBiDesc' id='GMCTHBiDesc' class='form-control few-options' 
                                                                maxlength="100"  placeholder="BI Description">
                                                            </div>
                                                        </div>                                                            
                                                    </div>                                                                                 
                                                    ...
                                                    <div class="row mt-0">
                                                        <div class="col-md-6">
                                                            <div class='form-group '>
                                                                ...
                                                                <!-- <span class="error-text GMCTHStateId_error text-danger" style='float:right;'></span> -->
                                                                <select id='selectState'name='selectState' style='width: 100%;'>
                                                        ...
                                                        <div class="col-md-6">                                               
                                                            <div class='form-group '>
                                                                <label>Country</label>
                                                                <input type="text" name='selectCountry' id='selectCountry'value='' 
                                                                    class='form-control few-options' maxlength="100" readonly>
                                                            </div>
                                                        </div>
                                                    </div>                                                    
                                                    <!-- End of dropdown -->                                         
                                ...
                                <div class='modal-footer'>
                                    <span id='form_output' style='float:left; padding-left:0px' ></span> <!--To display success messages-->
        ...
        $(document).ready(function(){
            ...
            $('#html5-extension3SIS').DataTable( {
                ...
                "columns":[                    
                    ...
                    {data: "GMCMHDesc1"},
                    {data: "GMCTHUser"},
                    {data: "GMCTHLastUpdated"},
                    {data: "action", orderable:false, searchable: false},
                    {data: "GMCTHUniqueId", "visible": false}
                ],
                "columnDefs": [
                    { "width": "5%", "targets": 0 },
                    { "width": "15%", "targets": 1 },
            ...
            // Whed add button is pushed
            $('#add_Data').click(function(){
                $("#GMCTHCityId").attr("readonly", false); 
            ...
            $(document).on('click', '.edit', function(){
                var id = $(this).attr('id');
                $.ajax({
                    url: "{{route('city.fetchdata')}}",
                    method: 'GET',
                    data: {id:id},
                    dataType: 'json',
                    success: function(data)
                    {
                        var lastCreated = formattedDate(new Date(data.GMCTHLastCreated));
                        var lastUpdated = formattedDate(new Date(data.GMCTHLastUpdated));
                        $('#GMCTHUniqueId').val(data.GMCTHUniqueId);
                        $('#GMCTHCityId').val(data.GMCTHCityId);
                        $('#GMCTHDesc1').val(data.GMCTHDesc1);
                        $('#GMCTHDesc2').val(data.GMCTHDesc2);
                        $('#GMCTHBiDesc').val(data.GMCTHBiDesc);
                        $("#GMCTHCityId").attr("readonly", true);
                        $('#GMCTHUser').val(data.GMCTHUser);                        
                        $('#GMCTHLastCreated').val(lastCreated);                        
                        $('#GMCTHLastUpdated').val(lastUpdated);                            
            ...
            $(document).on('click', '.delete', function(){
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        $deleteMessage3SIS = fnSingleLevelDeleteConfirmation('', data.GMCTHCityId, data.GMCTHDesc1);   
            ...
            $('#Undelete_Data').click(function(){                    
                ...
                destroy: true,                    
                // CopyChange                    
                "ajax": "{{ route('city.browserDeletedRecords')}}",
                "columns":[
                    // CopyChange
                    {data: "GMCTHCityId"},
                    {data: "GMCTHDesc1"},
            ...
            // When State Id is selected, bring Country Desc
            $('#selectState').change(function(){
                let id = $(this).val();
                $.ajax({
                    url: "{{route('state.getCountry')}}",
                    type:'post',
                    data:'stateId=' + id + '&_token={{csrf_token()}}',
                    success:function(response){
                        $('#selectCountry').val(response)
                    }
                })
            });
            // Bringing Country Desc Ends
            ...
            $(document).on('click', '.restore', function(){
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        $restoreMessage3SIS = fnSingleLevelRestoreConfirmation($modalTitle, data.GMCTHCityId, '');   
                ...
                $(document).on('click', '.confirmrestore', function(){
                    $.ajax({
                        url:"{{route('city.restoreDeletedRecords')}}",
                        mehtod:"get",
                        data:{id:DeletedUniqueId},
                        success:function(data)
                        {                       
