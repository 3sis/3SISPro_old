                                ...
                                <div class="container-fluid">
                                        <div class="table-responsive">
                                            <table id="html-extension3SIS" class="table table-hover non-hover" style="width:100%">
                                                <thead>
                                                    <tr>                                                                
                                                        <th title="Currency Master">ID</th>
                                                        <th>Currency</th>
                                                        <th>Desc1</th>
                                                        <th>Action</th>
                                                        <th style="visibility: hidden;">Unique Id</th>
                ...
                <div class="modal-dialog modal-dialog-centered 3SISPro-modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form id="singleLevelDataEntryForm" autocomplete="off" 
                            method="post" action="{{ route('currency.postData') }}">
                                        ...
                                        <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" 
                                            ...
                                            <div class="container-fluid">
                                                <div class="form-group">
                                                    <input type="hidden" name="GMCRHUniqueId" id="GMCRHUniqueId" class="form-control" />
                                                </div>
                                                <div class="row mt-0">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Currency Id</label>
                                                            <span class="error-text GMCRHCurrencyId_error text-danger" style="float: right;"></span>
                                                            <input type="text" name="GMCRHCurrencyId" id="GMCRHCurrencyId" class="form-control few-options" maxlength="10" placeholder="Currency Id" style="opacity: 1;" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Curr.Description</label>
                                                            <span class="error-text GMCRHDesc1_error text-danger" style="float: right;"></span>
                                                            <input type="text" name="GMCRHDesc1" id="GMCRHDesc1" class="form-control few-options" maxlength="100" placeholder="Currency Description" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Description2</label>
                                                    <span class="error-text GMCRHDesc2_error text-danger" style="float: right;"></span>
                                                    <textarea
                                                        name="GMCRHDesc2"
                                                        id="GMCRHDesc2"
                                                        ...
                                                        name="alloptions"
                                                        id="alloptions1"
                                                        placeholder="Currency Description2"
                                                ...
                                                <div class="form-group">
                                                    <label>BI Desc</label>
                                                    <span class="error-text GMCRHBiDesc_error text-danger" style="float: right;"></span>
                                                    <input type="text" name="GMCRHBiDesc" id="GMCRHBiDesc" class="form-control few-options" maxlength="100" placeholder="BI Description" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="animated-underline-profile" role="tabpanel" 
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    <div class="form-group">
                                                        <label> User</label>
                                                        <input type="text" name="GMCRHUser" id="GMCRHUser" 
                                                        class="form-control col-sm-6" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label> Created Date</label>
                                                        <input type="date" name="GMCRHLastCreated" id="GMCRHLastCreated" 
                                                        class="form-control col-sm-6" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label> Updated Date</label>
                                                        <input type="date" name="GMCRHLastUpdated" id="GMCRHLastUpdated" 
                                                        class="form-control col-sm-6" readonly />
                                                    </div>                                                        
                                                </div>
                                            </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#html5-extension3SIS').DataTable( {
            ...
            processing: true,
            serverSide: true,                
            "ajax": "{{ route('currency.browserData')}}",        
            "columns":[                    
                {data: "GMCRHCurrencyId"},
                {data: "GMCRHDesc1"},
                {data: "GMCRHDesc2"},                
                {data: "action", orderable:false, searchable: false},
                {data: "GMCRHUser", "visible": false},
                {data: "GMCRHLastUpdated", "visible": false},
                {data: "GMCRHUniqueId", "visible": false},
            ],
            "columnDefs": [
                { "width": "10%", "targets": 0 },
                { "width": "25%", "targets": 1 },
        ...
        $('#add_Data').click(function(){                    
            $("#GMCRHCurrencyId").attr("readonly", false);                
        ...
        $(document).on('click', '.edit', function(){
            var id = $(this).attr('id');
            $.ajax({
                url: "{{route('currency.fetchData')}}",
                method: 'GET',
                data: {id:id},
                dataType: 'json',
                success: function(data)
                {
                    var lastCreated = formattedDate(new Date(data.GMCRHLastCreated));
                    var lastUpdated = formattedDate(new Date(data.GMCRHLastUpdated));
                    $('#GMCRHUniqueId').val(data.GMCRHUniqueId);
                    $('#GMCRHCurrencyId').val(data.GMCRHCurrencyId);
                    $('#GMCRHDesc1').val(data.GMCRHDesc1);
                    $('#GMCRHDesc2').val(data.GMCRHDesc2);
                    $('#GMCRHBiDesc').val(data.GMCRHBiDesc);
                    $('#GMCRHUser').val(data.GMCRHUser);
                    $('#GMCRHLastCreated').val(lastCreated);
                    $('#GMCRHLastUpdated').val(lastUpdated);
                    $("#GMCRHCurrencyId").attr("readonly", true);                       
        ...
        $(document).on('click', '.delete', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $deleteMessage3SIS = fnSingleLevelDeleteConfirmation($modalTitle, data.GMCRHCurrencyId, data.GMCRHDesc1);   
        ...
        $('#Undelete_Data').click(function(){                    
            ...
            destroy: true,                    
            // CopyChange                    
            "ajax": "{{ route('currency.browserDeletedRecords')}}",
                "columns":[
                    // CopyChange
                    {data: "GMCRHCurrencyId"},
                    {data: "GMCRHDesc1"},
        ...
        $(document).on('click', '.restore', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $restoreMessage3SIS = fnSingleLevelRestoreConfirmation($modalTitle, data.GMCRHCurrencyId, '');   
            ...
            $(document).on('click', '.confirmrestore', function(){
                $.ajax({
                    url:"{{route('currency.restoreDeletedRecords')}}",
                    mehtod:"get",
                    data:{id:DeletedUniqueId},
                    success:function(data)
                    {                       
