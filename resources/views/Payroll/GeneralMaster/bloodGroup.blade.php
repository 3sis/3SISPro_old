                                ...
                                <div class="container-fluid">
                                        <div class="table-responsive">
                                            <table id="html-extension3SIS" class="table table-hover non-hover" style="width:100%">
                                                <thead>
                                                    <tr>                                                                
                                                        <th title="BloodGroup Master">ID</th>
                                                        <th>Blood Group</th>
                                                        <th>Desc1</th>
                                                        <th>Action</th>
                                                        <th style="visibility: hidden;">Unique Id</th>
                ...
                <div class="modal-dialog modal-dialog-centered 3SISPro-modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form id="singleLevelDataEntryForm" autocomplete="off" 
                            method="post" action="{{ route('bloodGroup.postData') }}">
                                        ...
                                        <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" 
                                            ...
                                            <div class="container-fluid">
                                                <div class="form-group">
                                                    <input type="hidden" name="GMBGHUniqueId" id="GMBGHUniqueId" class="form-control" />
                                                </div>
                                                <div class="row mt-0">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>BloodGroup Id</label>
                                                            <span class="error-text GMBGHBloodGroupId_error text-danger" style="float: right;"></span>
                                                            <input type="text" name="GMBGHBloodGroupId" id="GMBGHBloodGroupId" class="form-control few-options" maxlength="10" placeholder="BloodGroup Id" style="opacity: 1;" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Description</label>
                                                            <span class="error-text GMBGHDesc1_error text-danger" style="float: right;"></span>
                                                            <input type="text" name="GMBGHDesc1" id="GMBGHDesc1" class="form-control few-options" maxlength="100" placeholder="BloodGroup Description" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Description2</label>
                                                    <span class="error-text GMBGHDesc2_error text-danger" style="float: right;"></span>
                                                    <textarea
                                                        name="GMBGHDesc2"
                                                        id="GMBGHDesc2"
                                                        ...
                                                        name="alloptions"
                                                        id="alloptions1"
                                                        placeholder="BloodGroup Description2"
                                                ...
                                                <div class="form-group">
                                                    <label>BI Desc</label>
                                                    <span class="error-text GMBGHBiDesc_error text-danger" style="float: right;"></span>
                                                    <input type="text" name="GMBGHBiDesc" id="GMBGHBiDesc" class="form-control few-options" maxlength="100" placeholder="BI Description" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="animated-underline-profile" role="tabpanel" 
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    <div class="form-group">
                                                        <label> User</label>
                                                        <input type="text" name="GMBGHUser" id="GMBGHUser" 
                                                        class="form-control col-sm-6" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label> Created Date</label>
                                                        <input type="date" name="GMBGHLastCreated" id="GMBGHLastCreated" 
                                                        class="form-control col-sm-6" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label> Updated Date</label>
                                                        <input type="date" name="GMBGHLastUpdated" id="GMBGHLastUpdated" 
                                                        class="form-control col-sm-6" readonly />
                                                    </div>                                                        
                                                </div>
                                            </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#html5-extension3SIS').DataTable( {
            ...
            processing: true,
            serverSide: true,                
            "ajax": "{{ route('bloodGroup.browserData')}}",        
            "columns":[                    
                {data: "GMBGHBloodGroupId"},
                {data: "GMBGHDesc1"},
                {data: "GMBGHDesc2"},                
                {data: "action", orderable:false, searchable: false},
                {data: "GMBGHUser", "visible": false},
                {data: "GMBGHLastUpdated", "visible": false},
                {data: "GMBGHUniqueId", "visible": false},
            ],
            "columnDefs": [
                { "width": "10%", "targets": 0 },
                { "width": "25%", "targets": 1 },
        ...
        $('#add_Data').click(function(){                    
            $("#GMBGHBloodGroupId").attr("readonly", false);                
        ...
        $(document).on('click', '.edit', function(){
            var id = $(this).attr('id');
            $.ajax({
                url: "{{route('bloodGroup.fetchData')}}",
                method: 'GET',
                data: {id:id},
                dataType: 'json',
                success: function(data)
                {
                    var lastCreated = formattedDate(new Date(data.GMBGHLastCreated));
                    var lastUpdated = formattedDate(new Date(data.GMBGHLastUpdated));
                    $('#GMBGHUniqueId').val(data.GMBGHUniqueId);
                    $('#GMBGHBloodGroupId').val(data.GMBGHBloodGroupId);
                    $('#GMBGHDesc1').val(data.GMBGHDesc1);
                    $('#GMBGHDesc2').val(data.GMBGHDesc2);
                    $('#GMBGHBiDesc').val(data.GMBGHBiDesc);
                    $('#GMBGHUser').val(data.GMBGHUser);
                    $('#GMBGHLastCreated').val(lastCreated);
                    $('#GMBGHLastUpdated').val(lastUpdated);
                    $("#GMBGHBloodGroupId").attr("readonly", true);                       
        ...
        $(document).on('click', '.delete', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $deleteMessage3SIS = fnSingleLevelDeleteConfirmation($modalTitle, data.GMBGHBloodGroupId, data.GMBGHDesc1);   
            ...
            $(document).on('click', '.confirm', function(){
                $.ajax({
                    url:"{{route('bloodGroup.deleteData')}}",
                    mehtod:"get",
                    data:{id:UniqueId},
                    success:function(data)
                    {
        ...
        $('#Undelete_Data').click(function(){                    
            ...
            destroy: true,                    
            // CopyChange                    
            "ajax": "{{ route('bloodGroup.browserDeletedRecords')}}",
                "columns":[
                    // CopyChange
                    {data: "GMBGHBloodGroupId"},
                    {data: "GMBGHDesc1"},
        ...
        $(document).on('click', '.restore', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $restoreMessage3SIS = fnSingleLevelRestoreConfirmation($modalTitle, data.GMBGHBloodGroupId, '');   
            ...
            $(document).on('click', '.confirmrestore', function(){
                $.ajax({
                    url:"{{route('bloodGroup.restoreDeletedRecords')}}",
                    mehtod:"get",
                    data:{id:DeletedUniqueId},
                    success:function(data)
                    {                       
