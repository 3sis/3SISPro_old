                                ...
                                <div class="container-fluid">
                                        <div class="table-responsive">
                                            <table id="html-extension3SIS" class="table table-hover non-hover" style="width:100%">
                                                <thead>
                                                    <tr>                                                                
                                                        <th title="Qualifications Master">ID</th>
                                                        <th>Qualifications</th>
                                                        <th>Desc1</th>
                                                        <th>Action</th>
                                                        <th style="visibility: hidden;">Unique Id</th>
                ...
                <div class="modal-dialog modal-dialog-centered 3SISPro-modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form id="singleLevelDataEntryForm" autocomplete="off" 
                            method="post" action="{{ route('qualification.postData') }}">
                                        ...
                                        <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" 
                                            ...
                                            <div class="container-fluid">
                                                <div class="form-group">
                                                    <input type="hidden" name="CMQUHUniqueId" id="CMQUHUniqueId" class="form-control" />
                                                </div>
                                                <div class="row mt-0">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Qualifications Id</label>
                                                            <span class="error-text CMQUHDegreeId_error text-danger" style="float: right;"></span>
                                                            <input type="text" name="CMQUHDegreeId" id="CMQUHDegreeId" class="form-control few-options" maxlength="10" placeholder="Qualifications Id" style="opacity: 1;" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Description</label>
                                                            <span class="error-text CMQUHDesc1_error text-danger" style="float: right;"></span>
                                                            <input type="text" name="CMQUHDesc1" id="CMQUHDesc1" class="form-control few-options" maxlength="100" placeholder="Qualifications Description" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Description2</label>
                                                    <span class="error-text CMQUHDesc2_error text-danger" style="float: right;"></span>
                                                    <textarea
                                                        name="CMQUHDesc2"
                                                        id="CMQUHDesc2"
                                                        ...
                                                        name="alloptions"
                                                        id="alloptions1"
                                                        placeholder="Qualifications Description2"
                                                ...
                                                <div class="form-group">
                                                    <label>BI Desc</label>
                                                    <span class="error-text CMQUHBiDesc_error text-danger" style="float: right;"></span>
                                                    <input type="text" name="CMQUHBiDesc" id="CMQUHBiDesc" class="form-control few-options" maxlength="100" placeholder="BI Description" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="animated-underline-profile" role="tabpanel" 
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    <div class="form-group">
                                                        <label> User</label>
                                                        <input type="text" name="CMQUHUser" id="CMQUHUser" 
                                                        class="form-control col-sm-6" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label> Created Date</label>
                                                        <input type="date" name="CMQUHLastCreated" id="CMQUHLastCreated" 
                                                        class="form-control col-sm-6" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label> Updated Date</label>
                                                        <input type="date" name="CMQUHLastUpdated" id="CMQUHLastUpdated" 
                                                        class="form-control col-sm-6" readonly />
                                                    </div>                                                        
                                                </div>
                                            </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#html5-extension3SIS').DataTable( {
            ...
            processing: true,
            serverSide: true,                
            "ajax": "{{ route('qualification.browserData')}}",        
            "columns":[                    
                {data: "CMQUHDegreeId"},
                {data: "CMQUHDesc1"},
                {data: "CMQUHDesc2"},                
                {data: "action", orderable:false, searchable: false},
                {data: "CMQUHUser", "visible": false},
                {data: "CMQUHLastUpdated", "visible": false},
                {data: "CMQUHUniqueId", "visible": false},
            ],
            "columnDefs": [
                { "width": "10%", "targets": 0 },
                { "width": "25%", "targets": 1 },
        ...
        $('#add_Data').click(function(){                    
            $("#CMQUHDegreeId").attr("readonly", false);                
        ...
        $(document).on('click', '.edit', function(){
            var id = $(this).attr('id');
            $.ajax({
                url: "{{route('qualification.fetchData')}}",
                method: 'GET',
                data: {id:id},
                dataType: 'json',
                success: function(data)
                {
                    var lastCreated = formattedDate(new Date(data.CMQUHLastCreated));
                    var lastUpdated = formattedDate(new Date(data.CMQUHLastUpdated));
                    $('#CMQUHUniqueId').val(data.CMQUHUniqueId);
                    $('#CMQUHDegreeId').val(data.CMQUHDegreeId);
                    $('#CMQUHDesc1').val(data.CMQUHDesc1);
                    $('#CMQUHDesc2').val(data.CMQUHDesc2);
                    $('#CMQUHBiDesc').val(data.CMQUHBiDesc);
                    $('#CMQUHUser').val(data.CMQUHUser);
                    $('#CMQUHLastCreated').val(lastCreated);
                    $('#CMQUHLastUpdated').val(lastUpdated);
                    $("#CMQUHDegreeId").attr("readonly", true);                       
        ...
        $(document).on('click', '.delete', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $deleteMessage3SIS = fnSingleLevelDeleteConfirmation($modalTitle, data.CMQUHDegreeId, data.CMQUHDesc1);   
            ...
            $(document).on('click', '.confirm', function(){
                $.ajax({
                    url:"{{route('qualification.deleteData')}}",
                    mehtod:"get",
                    data:{id:UniqueId},
                    success:function(data)
                    {
        ...
        $('#Undelete_Data').click(function(){                    
            ...
            destroy: true,                    
            // CopyChange                    
            "ajax": "{{ route('qualification.browserDeletedRecords')}}",
                "columns":[
                    // CopyChange
                    {data: "CMQUHDegreeId"},
                    {data: "CMQUHDesc1"},
        ...
        $(document).on('click', '.restore', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $restoreMessage3SIS = fnSingleLevelRestoreConfirmation($modalTitle, data.CMQUHDegreeId, '');   
            ...
            $(document).on('click', '.confirmrestore', function(){
                $.ajax({
                    url:"{{route('qualification.restoreDeletedRecords')}}",
                    mehtod:"get",
                    data:{id:DeletedUniqueId},
                    success:function(data)
                    {                       
