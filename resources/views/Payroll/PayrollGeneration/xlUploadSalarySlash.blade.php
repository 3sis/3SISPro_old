                    ...
                    <div class="card component-card_1">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs mb-3" id="animateLine" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="animated-underline-salarySlash-tab" data-toggle="tab" 
                                    href="#animated-underline-salarySlash" role="tab" aria-controls="animated-underline-salarySlash" 
                                    aria-selected="false">salary Slash</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="animateLineContent-4">
                                ...
                                <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" 
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <form id='importDataForm' autocomplete="off"
                                             method="POST" enctype="multipart/form-data" action="{{route('salarySlash.import')}}">
                                ...
                                <div class="tab-pane fade" id="animated-underline-salarySlash" role="tabpanel" 
                                    aria-labelledby="animated-underline-salarySlash-tab">
                                    <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                                        ...
                                        <div class="br-6">
                                            ...
                                            <form  id='singleLevelDataEntryForm' autocomplete="off"
                                                method="post" action="{{ route('salarySlash.postData') }}">
...
<script>
    $(document).ready(function(){
        ...
        $("#animated-underline-salarySlash-tab").hide();
        $('#html5-extension3SIS').DataTable( {
            ...
            destroy: true,
            searching: false,               
            "ajax": "{{ route('salarySlash.browserData')}}",
            "columns":[                    
    ...
    $(document).on('click', '.columnSelect', function(){
            ...
            $.ajax({
                // CopyChange
                url: "{{route('salarySlash.select_UnSelect')}}",
                method: 'GET',
        ...
        $(document).on('click', '.columnDefsIncome', function(){
            ...
            $.ajax({
                // CopyChange
                url: "{{route('salarySlash.select_UnSelectIncomeType')}}",
                method: 'GET',
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                { 
                    ...
                    fnLoadSalaryRevisionSubForm();
                    $("#animated-underline-salarySlash-tab").show();
                    $("#animated-underline-salarySlash-tab").trigger('click');
                }
            }
        })
    });    
    ...
    $('#SelectIncomeType').click(function(){
        ...
        $('#userConfirmationNo').one('click', function(){
            $.ajax({
                // CopyChange
                url: "{{route('salarySlash.updateIncomeTypeMem')}}",
                mehtod:"get",
                data: {UpdateMode:1},
                success:function(data)
                {
    ...
    function fnLoadIncomeTypeListSubForm(){
        $('#html5-incomeTypeSubform3SIS').DataTable( {
            ...
            destroy: true,
            searching: false,               
            "ajax": "{{ route('salarySlash.browserIncomeTypeList')}}",        
            "columns":[                    
                {data: "PMSSHSelect"},
                {data: "PMSSHIncomeId"},                
                {data: "PMSSHDesc1"},
