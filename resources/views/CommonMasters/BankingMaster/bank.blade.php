                        ...
                        <div class="modal-dialog modal-dialog-centered 3SISPro-modal-dialog modal-lg" role="document">  
                            <div class='modal-content'>                              
                                ...
                                <form  id='singleLevelDataEntryForm' autocomplete="off"
                                     method="post" action="{{ route('bank.postData') }}">
                                                    ...
                                                    <div class="container-fluid">
                                                        ...
                                                        <div class="row mt-0">
                                                            <div class="col-md-6">
                                                                <div class='form-group'>                                                
                                                                    <label>Bank Id</label> 
                                                                    <span class="error-text BMBNHBankId_error text-danger" 
                                                                        style='float:right;'></span>
                                                                    <input type="text"  name='BMBNHBankId' id='BMBNHBankId' 
                                                                        class='form-control few-options' maxlength="4" 
                                                                        placeholder="Bank Id" style='opacity:1'>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class='form-group'>                                                
                                                                    <label>Bank Description</label> 
                                                                    <span class="error-text BMBNHDesc1_error text-danger" 
                                                                        style='float:right;'></span>
                                                                    <input type="text" name='BMBNHDesc1' id="BMBNHDesc1"  maxlength="100"
                                                        ...
                                                        <div class='form-group'>                                                
                                                            ...
                                                            <textarea name='BMBNHDesc2' id='BMBNHDesc2' class='form-control few-options' 
                                                            maxlength="200" name="alloptions" id="alloptions1" placeholder="Bank Description2" 
                                                        ...
                                                        <div class='form-group '>
                                                            ...
                                                            <input type="text" name='BMBNHBiDesc' id='BMBNHBiDesc' 
                                                    ...
                                                    <div class="media">
                                                        <div class="media-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" name="BMBNHLastCreated" id="BMBNHLastCreated" 
                                                                class="form-control col-sm-6" readonly/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label> Updated Date</label>
                                                                <input type="date" name="BMBNHLastUpdated" id="BMBNHLastUpdated" 
                                                                class="form-control col-sm-6" readonly />
                                                            </div>                                                        
                                                        </div>
                                                    </div>
        ...
        $(document).ready(function(){
            ...
            $('#html5-extension3SIS').DataTable( {
                ...
                "columns":[
                    ...
                    {data: "BMBNHBiDesc"},
                    {data: "BMBNHUser"},
                    {data: "BMBNHLastUpdated"},
                    {data: "action", orderable:false, searchable: false},
                    {data: "BMBNHUniqueId", "visible": false},
            ...
            $('#add_Data').click(function(){                    
                $("#BMBNHBankId").attr("readonly", false);
            ...
            $(document).on('click', '.edit', function(){
                ...
                $.ajax({
                    // CopyChange
                    url: "{{route('bank.fetchData')}}",
                    method: 'GET',
                    data: {id:id},
                    dataType: 'json',
                    success: function(data)
                    {                        
                        var lastCreated = formattedDate(new Date(data.BMBNHLastCreated));
                        var lastUpdated = formattedDate(new Date(data.BMBNHLastUpdated));
                        $('#BMBNHUniqueId').val(data.BMBNHUniqueId);                       
                        $('#BMBNHBankId').val(data.BMBNHBankId);
                        $('#BMBNHDesc1').val(data.BMBNHDesc1);
                        $('#BMBNHDesc2').val(data.BMBNHDesc2);  
                        $('#BMBNHBiDesc').val(data.BMBNHBiDesc);
                        $('#BMBNHUser').val(data.BMBNHUser);
                        $('#BMBNHLastCreated').val(lastCreated);
                        $('#BMBNHLastUpdated').val(lastUpdated);                        

                        $("#BMBNHBankId").attr("readonly", true);                           
            ...
            $(document).on('click', '.delete', function(){
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        $deleteMessage3SIS = fnSingleLevelDeleteConfirmation($modalTitle, data.BMBNHBankId, '');   
            ...
            $('#Undelete_Data').click(function(){                    
                ...
                destroy: true,                    
                // CopyChange                    
                "ajax": "{{ route('bank.browserDeletedRecords')}}",
                "columns":[
                    // CopyChange
                    {data: "BMBNHBankId"},
                    {data: "BMBNHDesc1"},
            ...
            $(document).on('click', '.restore', function(){
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        $restoreMessage3SIS = fnSingleLevelRestoreConfirmation($modalTitle, data.BMBNHBankId, '');   
                ...
                $(document).on('click', '.confirmrestore', function(){
                    $.ajax({
                        url:"{{route('bank.restoreDeletedRecords')}}",
                        mehtod:"get",
                        data:{id:DeletedUniqueId},
                        success:function(data)
                        {                       
