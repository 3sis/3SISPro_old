                                ...
                                <div class="container-fluid">
                                        <div class="table-responsive">
                                            <table id="html-extension3SIS" class="table table-hover non-hover" style="width:100%">
                                                <thead>
                                                    <tr>                                                                
                                                        <th title="PhysicalStatus Master">ID</th>
                                                        <th>Physical Status</th>
                                                        <th>Desc1</th>
                                                        <th>Action</th>
                                                        <th style="visibility: hidden;">Unique Id</th>
                ...
                <div class="modal-dialog modal-dialog-centered 3SISPro-modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form id="singleLevelDataEntryForm" autocomplete="off" 
                            method="post" action="{{ route('physicalStatus.postData') }}">
                                        ...
                                        <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" 
                                            ...
                                            <div class="container-fluid">
                                                <div class="form-group">
                                                    <input type="hidden" name="GMPSHUniqueId" id="GMPSHUniqueId" class="form-control" />
                                                </div>
                                                <div class="row mt-0">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>PhysicalStatus Id</label>
                                                            <span class="error-text GMPSHPhysicalStatusId_error text-danger" style="float: right;"></span>
                                                            <input type="text" name="GMPSHPhysicalStatusId" id="GMPSHPhysicalStatusId" class="form-control few-options" maxlength="10" placeholder="PhysicalStatus Id" style="opacity: 1;" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Description</label>
                                                            <span class="error-text GMPSHDesc1_error text-danger" style="float: right;"></span>
                                                            <input type="text" name="GMPSHDesc1" id="GMPSHDesc1" class="form-control few-options" maxlength="100" placeholder="PhysicalStatus Description" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Description2</label>
                                                    <span class="error-text GMPSHDesc2_error text-danger" style="float: right;"></span>
                                                    <textarea
                                                        name="GMPSHDesc2"
                                                        id="GMPSHDesc2"
                                                        ...
                                                        name="alloptions"
                                                        id="alloptions1"
                                                        placeholder="PhysicalStatus Description2"
                                                ...
                                                <div class="form-group">
                                                    <label>BI Desc</label>
                                                    <span class="error-text GMPSHBiDesc_error text-danger" style="float: right;"></span>
                                                    <input type="text" name="GMPSHBiDesc" id="GMPSHBiDesc" class="form-control few-options" maxlength="100" placeholder="BI Description" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="animated-underline-profile" role="tabpanel" 
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    <div class="form-group">
                                                        <label> User</label>
                                                        <input type="text" name="GMPSHUser" id="GMPSHUser" 
                                                        class="form-control col-sm-6" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label> Created Date</label>
                                                        <input type="date" name="GMPSHLastCreated" id="GMPSHLastCreated" 
                                                        class="form-control col-sm-6" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label> Updated Date</label>
                                                        <input type="date" name="GMPSHLastUpdated" id="GMPSHLastUpdated" 
                                                        class="form-control col-sm-6" readonly />
                                                    </div>                                                        
                                                </div>
                                            </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#html5-extension3SIS').DataTable( {
            ...
            processing: true,
            serverSide: true,                
            "ajax": "{{ route('physicalStatus.browserData')}}",        
            "columns":[                    
                {data: "GMPSHPhysicalStatusId"},
                {data: "GMPSHDesc1"},
                {data: "GMPSHDesc2"},                
                {data: "action", orderable:false, searchable: false},
                {data: "GMPSHUser", "visible": false},
                {data: "GMPSHLastUpdated", "visible": false},
                {data: "GMPSHUniqueId", "visible": false},
            ],
            "columnDefs": [
                { "width": "10%", "targets": 0 },
                { "width": "25%", "targets": 1 },
        ...
        $('#add_Data').click(function(){                    
            $("#GMPSHPhysicalStatusId").attr("readonly", false);                
        ...
        $(document).on('click', '.edit', function(){
            var id = $(this).attr('id');
            $.ajax({
                url: "{{route('physicalStatus.fetchData')}}",
                method: 'GET',
                data: {id:id},
                dataType: 'json',
                success: function(data)
                {
                    var lastCreated = formattedDate(new Date(data.GMPSHLastCreated));
                    var lastUpdated = formattedDate(new Date(data.GMPSHLastUpdated));
                    $('#GMPSHUniqueId').val(data.GMPSHUniqueId);
                    $('#GMPSHPhysicalStatusId').val(data.GMPSHPhysicalStatusId);
                    $('#GMPSHDesc1').val(data.GMPSHDesc1);
                    $('#GMPSHDesc2').val(data.GMPSHDesc2);
                    $('#GMPSHBiDesc').val(data.GMPSHBiDesc);
                    $('#GMPSHUser').val(data.GMPSHUser);
                    $('#GMPSHLastCreated').val(lastCreated);
                    $('#GMPSHLastUpdated').val(lastUpdated);
                    $("#GMPSHPhysicalStatusId").attr("readonly", true);                       
        ...
        $(document).on('click', '.delete', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $deleteMessage3SIS = fnSingleLevelDeleteConfirmation($modalTitle, data.GMPSHPhysicalStatusId, data.GMPSHDesc1);   
            ...
            $(document).on('click', '.confirm', function(){
                $.ajax({
                    url:"{{route('physicalStatus.deleteData')}}",
                    mehtod:"get",
                    data:{id:UniqueId},
                    success:function(data)
                    {
        ...
        $('#Undelete_Data').click(function(){                    
            ...
            destroy: true,                    
            // CopyChange                    
            "ajax": "{{ route('physicalStatus.browserDeletedRecords')}}",
                "columns":[
                    // CopyChange
                    {data: "GMPSHPhysicalStatusId"},
                    {data: "GMPSHDesc1"},
        ...
        $(document).on('click', '.restore', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $restoreMessage3SIS = fnSingleLevelRestoreConfirmation($modalTitle, data.GMPSHPhysicalStatusId, '');   
            ...
            $(document).on('click', '.confirmrestore', function(){
                $.ajax({
                    url:"{{route('physicalStatus.restoreDeletedRecords')}}",
                    mehtod:"get",
                    data:{id:DeletedUniqueId},
                    success:function(data)
                    {                       
