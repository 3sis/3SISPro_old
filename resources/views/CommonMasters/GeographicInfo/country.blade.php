                    ...
                    <div class="modal-dialog modal-dialog-centered 3SISPro-modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <form id="singleLevelDataEntryForm" autocomplete="off" 
                                method="post" action="{{ route('country.postdata') }}">
                                            ...
                                            <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" 
                                                ...
                                                <div class="container-fluid">
                                                    <div class="form-group">
                                                        <input type="hidden" name="GMCMHUniqueId" id="GMCMHUniqueId" class="form-control" />
                                                    </div>
                                                    <div class="row mt-0">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Country Id</label>
                                                                <span class="error-text GMCMHCountryId_error text-danger" style="float: right;"></span>
                                                                <input type="text" name="GMCMHCountryId" id="GMCMHCountryId" class="form-control few-options" maxlength="10" placeholder="Country Id" style="opacity: 1;" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Country Description</label>
                                                                <span class="error-text GMCMHDesc1_error text-danger" style="float: right;"></span>
                                                                <input type="text" name="GMCMHDesc1" id="GMCMHDesc1" class="form-control few-options" maxlength="100" placeholder="Country Description" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Description2</label>
                                                        <span class="error-text GMCMHDesc2_error text-danger" style="float: right;"></span>
                                                        <textarea
                                                            name="GMCMHDesc2"
                                                            id="GMCMHDesc2"
                                                            ...
                                                            name="alloptions"
                                                            id="alloptions1"
                                                            placeholder="Country Description2"
                                                    ...
                                                    <div class="form-group">
                                                        <label>BI Desc</label>
                                                        <span class="error-text GMCMHBiDesc_error text-danger" style="float: right;"></span>
                                                        <input type="text" name="GMCMHBiDesc" id="GMCMHBiDesc" class="form-control few-options" maxlength="100" placeholder="BI Description" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="animated-underline-profile" role="tabpanel" 
                                                ...
                                                <div class="media">
                                                    <div class="media-body">
                                                        <div class="form-group">
                                                            <label> User</label>
                                                            <input type="text" name="GMCMHUser" id="GMCMHUser" 
                                                            class="form-control col-sm-6" readonly/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label> Created Date</label>
                                                            <input type="date" name="GMCMHLastCreated" id="GMCMHLastCreated" 
                                                            class="form-control col-sm-6" readonly/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label> Updated Date</label>
                                                            <input type="date" name="GMCMHLastUpdated" id="GMCMHLastUpdated" 
                                                            class="form-control col-sm-6" readonly />
                                                        </div>                                                        
                                                    </div>
                                                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#html5-extension3SIS').DataTable( {
                ...
                processing: true,
                serverSide: true,                
                "ajax": "{{ route('country.browserData')}}",        
                "columns":[                    
                    {data: "GMCMHCountryId"},
                    {data: "GMCMHDesc1"},
                    {data: "GMCMHDesc2"},
                    {data: "GMCMHUser"},
                    {data: "GMCMHLastUpdated"},
                    {data: "action", orderable:false, searchable: false},
                    {data: "GMCMHUniqueId", "visible": false},
                ],
                "columnDefs": [
                    { "width": "5%", "targets": 0 },
                    { "width": "20%", "targets": 1 },
            ...
            $('#add_Data').click(function(){                    
                $("#GMCMHCountryId").attr("readonly", false);                
            ...
            $(document).on('click', '.edit', function(){
                ...
                var id = $(this).attr('id');
                $.ajax({
                    url: "{{route('country.fetchdata')}}",
                    method: 'GET',
                    data: {id:id},
                    dataType: 'json',
                    success: function(data)
                    {
                        var lastCreated = formattedDate(new Date(data.GMCMHLastCreated));
                        var lastUpdated = formattedDate(new Date(data.GMCMHLastUpdated));
                        $('#GMCMHUniqueId').val(data.GMCMHUniqueId);
                        $('#GMCMHCountryId').val(data.GMCMHCountryId);
                        $('#GMCMHDesc1').val(data.GMCMHDesc1);
                        $('#GMCMHDesc2').val(data.GMCMHDesc2);
                        $('#GMCMHBiDesc').val(data.GMCMHBiDesc);
                        $('#GMCMHUser').val(data.GMCMHUser);
                        $('#GMCMHLastCreated').val(lastCreated);
                        $('#GMCMHLastUpdated').val(lastUpdated);
                        $("#GMCMHCountryId").attr("readonly", true);                       
            ...
            $(document).on('click', '.delete', function(){
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        $deleteMessage3SIS = fnSingleLevelDeleteConfirmation($modalTitle, data.GMCMHCountryId, data.GMCMHDesc1);   
            ...
            $('#Undelete_Data').click(function(){                    
                ...
                destroy: true,                    
                // CopyChange                    
                "ajax": "{{ route('country.browserDeletedRecords')}}",
                    "columns":[
                        // CopyChange
                        {data: "GMCMHCountryId"},
                        {data: "GMCMHDesc1"},
            ...
            $(document).on('click', '.restore', function(){
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        $restoreMessage3SIS = fnSingleLevelRestoreConfirmation($modalTitle, data.GMCMHCountryId, '');   
                ...
                $(document).on('click', '.confirmrestore', function(){
                    $.ajax({
                        url:"{{route('country.restoreDeletedRecords')}}",
                        mehtod:"get",
                        data:{id:DeletedUniqueId},
                        success:function(data)
                        {                       
