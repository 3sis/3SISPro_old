                    ...
                    <div class="table-responsive">
                        <table id="html5-extension3SIS" class="table table-hover non-hover" style="width:100%">
                            <thead>
                                <tr>
                                    <!--CopyChange-->  
                                    <th title="PaymentMode Master">ID</th>
                        ...
                        <div class="modal-dialog modal-dialog-centered 3SISPro-modal-dialog modal-lg" role="document"> 
                            <div class='modal-content'>                              
                                ...
                                <form  id='singleLevelDataEntryForm' autocomplete="off"
                                     method="post" action="{{ route('paymentMode.postData') }}">
                                                ...
                                                <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" 
                                                    ...
                                                    <div class="container-fluid">
                                                        <div class='form-group'>
                                                            <input type="hidden" name='BMPMHUniqueId' id='BMPMHUniqueId' 
                                                                class='form-control'>
                                                        </div>
                                                        <div class="row mt-0">
                                                            <div class="col-md-6">
                                                                <div class='form-group'>                                                
                                                                    <label>PaymentMode Id</label> 
                                                                    <span class="error-text BMPMHPaymentModeId_error text-danger" 
                                                                        style='float:right;'></span>
                                                                    <input type="text"  name='BMPMHPaymentModeId' id='BMPMHPaymentModeId' 
                                                                        class='form-control few-options' maxlength="4" 
                                                                        placeholder="PaymentMode Id" style='opacity:1'>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class='form-group'>                                                
                                                                    <label>PaymentMode Description</label> 
                                                                    <span class="error-text BMPMHDesc1_error text-danger" 
                                                                        style='float:right;'></span>
                                                                    <input type="text" name='BMPMHDesc1' id="BMPMHDesc1"  maxlength="100"
                                                        ...
                                                        <div class='form-group'>                                                
                                                            ...
                                                            <textarea name='BMPMHDesc2' id='BMPMHDesc2' class='form-control few-options' 
                                                            maxlength="200" name="alloptions" id="alloptions1" placeholder="PaymentMode Description2" 
                                                        ...
                                                        <div class='form-group '>
                                                            ...
                                                            <input type="text" name='BMPMHBiDesc' id='BMPMHBiDesc' 
                                                ...
                                                <div class="tab-pane fade" id="animated-underline-profile" role="tabpanel" 
                                                    ...
                                                    <div class="media">
                                                        <div class="media-body">
                                                            <div class="form-group">
                                                                <label> User</label>
                                                                <input type="text" name="BMPMHUser" id="BMPMHUser" 
                                                                class="form-control col-sm-6" readonly/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label> Created Date</label>
                                                                <input type="date" name="BMPMHLastCreated" id="BMPMHLastCreated" 
                                                                class="form-control col-sm-6" readonly/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label> Updated Date</label>
                                                                <input type="date" name="BMPMHLastUpdated" id="BMPMHLastUpdated" 
                                                                class="form-control col-sm-6" readonly />
                                                            </div>                                                        
                                                        </div>
                                                    </div>
    ...
    <script>        
        $(document).ready(function(){
            ...
            $('#html5-extension3SIS').DataTable( {
                ...
                serverSide: true,
                // CopyChange                    
                "ajax": "{{ route('paymentMode.browserData')}}",
                "columns":[
                    // CopyChange
                    {data: "BMPMHPaymentModeId"},
                    {data: "BMPMHDesc1"},
                    {data: "BMPMHDesc2"},
                    {data: "BMPMHBiDesc"},
                    {data: "BMPMHUser"},
                    {data: "BMPMHLastUpdated"},
                    {data: "action", orderable:false, searchable: false},
                    {data: "BMPMHUniqueId", "visible": false},
            ...
            $('#add_Data').click(function(){                    
                $("#BMPMHPaymentModeId").attr("readonly", false);
            ...
            $(document).on('click', '.edit', function(){
                ...
                $.ajax({
                    // CopyChange
                    url: "{{route('paymentMode.fetchData')}}",
                    method: 'GET',
                    data: {id:id},
                    dataType: 'json',
                    success: function(data)
                    {                        
                        var lastCreated = formattedDate(new Date(data.BMPMHLastCreated));
                        var lastUpdated = formattedDate(new Date(data.BMPMHLastUpdated));
                        $('#BMPMHUniqueId').val(data.BMPMHUniqueId);                       
                        $('#BMPMHPaymentModeId').val(data.BMPMHPaymentModeId);
                        $('#BMPMHDesc1').val(data.BMPMHDesc1);
                        $('#BMPMHDesc2').val(data.BMPMHDesc2);  
                        $('#BMPMHBiDesc').val(data.BMPMHBiDesc);                        
                        $('#BMPMHUser').val(data.BMPMHUser);
                        $('#BMPMHLastCreated').val(lastCreated);
                        $('#BMPMHLastUpdated').val(lastUpdated); 
                        $("#BMPMHPaymentModeId").attr("readonly", true);                           
            ...
            $(document).on('click', '.delete', function(){
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        $deleteMessage3SIS = fnSingleLevelDeleteConfirmation($modalTitle, data.BMPMHPaymentModeId, '');   
                ...
                $(document).on('click', '.confirm', function(){
                    $.ajax({
                        // CopyChange
                        url:"{{route('paymentMode.deleteData')}}",
                        mehtod:"get",
                        data:{id:UniqueId},
                        success:function(data)
                        {
            ...
            $('#Undelete_Data').click(function(){                    
                ...
                destroy: true,                    
                // CopyChange                    
                "ajax": "{{ route('paymentMode.browserDeletedRecords')}}",
                "columns":[
                    // CopyChange
                    {data: "BMPMHPaymentModeId"},
                    {data: "BMPMHDesc1"},
            ...
            $(document).on('click', '.restore', function(){
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        $restoreMessage3SIS = fnSingleLevelRestoreConfirmation($modalTitle, data.BMPMHPaymentModeId, '');   
                ...
                $(document).on('click', '.confirmrestore', function(){
                    $.ajax({
                        url:"{{route('paymentMode.restoreDeletedRecords')}}",
                        mehtod:"get",
                        data:{id:DeletedUniqueId},
                        success:function(data)
                        {                       
