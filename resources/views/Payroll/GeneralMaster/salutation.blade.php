                                ...
                                <div class="container-fluid">
                                        <div class="table-responsive">
                                            <table id="html-extension3SIS" class="table table-hover non-hover" style="width:100%">
                                                <thead>
                                                    <tr>                                                                
                                                        <th title="Salutation Master">ID</th>
                                                        <th>Salutation</th>
                                                        <th>Desc1</th>
                                                        <th>Action</th>
                                                        <th style="visibility: hidden;">Unique Id</th>
                ...
                <div class="modal-dialog modal-dialog-centered 3SISPro-modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form id="singleLevelDataEntryForm" autocomplete="off" 
                            method="post" action="{{ route('salutation.postData') }}">
                                        ...
                                        <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" 
                                            ...
                                            <div class="container-fluid">
                                                <div class="form-group">
                                                    <input type="hidden" name="GMSLHUniqueId" id="GMSLHUniqueId" class="form-control" />
                                                </div>
                                                <div class="row mt-0">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Salutation Id</label>
                                                            <span class="error-text GMSLHSalutationId_error text-danger" style="float: right;"></span>
                                                            <input type="text" name="GMSLHSalutationId" id="GMSLHSalutationId" class="form-control few-options" maxlength="10" placeholder="Salutation Id" style="opacity: 1;" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Description</label>
                                                            <span class="error-text GMSLHDesc1_error text-danger" style="float: right;"></span>
                                                            <input type="text" name="GMSLHDesc1" id="GMSLHDesc1" class="form-control few-options" maxlength="100" placeholder="Salutation Description" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Description2</label>
                                                    <span class="error-text GMSLHDesc2_error text-danger" style="float: right;"></span>
                                                    <textarea
                                                        name="GMSLHDesc2"
                                                        id="GMSLHDesc2"
                                                        ...
                                                        name="alloptions"
                                                        id="alloptions1"
                                                        placeholder="Salutation Description2"
                                                ...
                                                <div class="form-group">
                                                    <label>BI Desc</label>
                                                    <span class="error-text GMSLHBiDesc_error text-danger" style="float: right;"></span>
                                                    <input type="text" name="GMSLHBiDesc" id="GMSLHBiDesc" class="form-control few-options" maxlength="100" placeholder="BI Description" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="animated-underline-profile" role="tabpanel" 
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    <div class="form-group">
                                                        <label> User</label>
                                                        <input type="text" name="GMSLHUser" id="GMSLHUser" 
                                                        class="form-control col-sm-6" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label> Created Date</label>
                                                        <input type="date" name="GMSLHLastCreated" id="GMSLHLastCreated" 
                                                        class="form-control col-sm-6" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label> Updated Date</label>
                                                        <input type="date" name="GMSLHLastUpdated" id="GMSLHLastUpdated" 
                                                        class="form-control col-sm-6" readonly />
                                                    </div>                                                        
                                                </div>
                                            </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#html5-extension3SIS').DataTable( {
            ...
            processing: true,
            serverSide: true,                
            "ajax": "{{ route('salutation.browserData')}}",        
            "columns":[                    
                {data: "GMSLHSalutationId"},
                {data: "GMSLHDesc1"},
                {data: "GMSLHDesc2"},                
                {data: "action", orderable:false, searchable: false},
                {data: "GMSLHUser", "visible": false},
                {data: "GMSLHLastUpdated", "visible": false},
                {data: "GMSLHUniqueId", "visible": false},
            ],
            "columnDefs": [
                { "width": "10%", "targets": 0 },
                { "width": "25%", "targets": 1 },
        ...
        $('#add_Data').click(function(){                    
            $("#GMSLHSalutationId").attr("readonly", false);                
        ...
        $(document).on('click', '.edit', function(){
            var id = $(this).attr('id');
            $.ajax({
                url: "{{route('salutation.fetchData')}}",
                method: 'GET',
                data: {id:id},
                dataType: 'json',
                success: function(data)
                {
                    var lastCreated = formattedDate(new Date(data.GMSLHLastCreated));
                    var lastUpdated = formattedDate(new Date(data.GMSLHLastUpdated));
                    $('#GMSLHUniqueId').val(data.GMSLHUniqueId);
                    $('#GMSLHSalutationId').val(data.GMSLHSalutationId);
                    $('#GMSLHDesc1').val(data.GMSLHDesc1);
                    $('#GMSLHDesc2').val(data.GMSLHDesc2);
                    $('#GMSLHBiDesc').val(data.GMSLHBiDesc);
                    $('#GMSLHUser').val(data.GMSLHUser);
                    $('#GMSLHLastCreated').val(lastCreated);
                    $('#GMSLHLastUpdated').val(lastUpdated);
                    $("#GMSLHSalutationId").attr("readonly", true);                       
        ...
        $(document).on('click', '.delete', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $deleteMessage3SIS = fnSingleLevelDeleteConfirmation($modalTitle, data.GMSLHSalutationId, data.GMSLHDesc1);   
            ...
            $(document).on('click', '.confirm', function(){
                $.ajax({
                    url:"{{route('salutation.deleteData')}}",
                    mehtod:"get",
                    data:{id:UniqueId},
                    success:function(data)
                    {
        ...
        $('#Undelete_Data').click(function(){                    
            ...
            destroy: true,                    
            // CopyChange                    
            "ajax": "{{ route('salutation.browserDeletedRecords')}}",
                "columns":[
                    // CopyChange
                    {data: "GMSLHSalutationId"},
                    {data: "GMSLHDesc1"},
        ...
        $(document).on('click', '.restore', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $restoreMessage3SIS = fnSingleLevelRestoreConfirmation($modalTitle, data.GMSLHSalutationId, '');   
            ...
            $(document).on('click', '.confirmrestore', function(){
                $.ajax({
                    url:"{{route('salutation.restoreDeletedRecords')}}",
                    mehtod:"get",
                    data:{id:DeletedUniqueId},
                    success:function(data)
                    {                       
