                    ...
                    <div class="table-responsive">
                        <table id="html5-extension3SIS" class="table table-hover non-hover" style="width:100%">
                            <thead>
                                <tr>
                                    <!--CopyChange-->  
                                    <th title="AcctType Master">ID</th>
                                    <th>AcctType Name</th>
                                    <th>Desc2</th>
                                    <th>Bi Desc</th>
                                    <th>User</th>
                        ...
                        <div class="modal-dialog modal-dialog-centered 3SISPro-modal-dialog modal-lg" role="document">  
                            <div class='modal-content'>                              
                                ...
                                <form  id='singleLevelDataEntryForm' autocomplete="off"
                                     method="post" action="{{ route('acctType.postData') }}">
                                                ...
                                                <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" 
                                                    ...
                                                    <div class="container-fluid">
                                                        <div class='form-group'>
                                                            <input type="hidden" name='BMATHUniqueId' id='BMATHUniqueId' 
                                                                class='form-control'>                                                  
                                                        </div>
                                                        <div class="row mt-0">
                                                            <div class="col-md-6">
                                                                <div class='form-group'>                                                
                                                                    <label>AcctType Id</label> 
                                                                    <span class="error-text BMATHAcctId_error text-danger" 
                                                                        style='float:right;'></span>
                                                                    <input type="text"  name='BMATHAcctId' id='BMATHAcctId' 
                                                                        class='form-control few-options' maxlength="4" 
                                                                        placeholder="AcctType Id" style='opacity:1'>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class='form-group'>                                                
                                                                    <label>AcctType Description</label> 
                                                                    <span class="error-text BMATHDesc1_error text-danger" 
                                                                        style='float:right;'></span>
                                                                    <input type="text" name='BMATHDesc1' id="BMATHDesc1"  maxlength="100"
                                                        ...
                                                        <div class='form-group'>                                                
                                                            ...
                                                            <textarea name='BMATHDesc2' id='BMATHDesc2' class='form-control few-options' 
                                                            maxlength="200" name="alloptions" id="alloptions1" placeholder="AcctType Description2" 
                                                            aria-label="With textarea" 
                                                            style='border-color: rgb(102, 175, 233); outline: 0px'></textarea>
                                                        </div>
                                                        <div class='form-group '>
                                                            <label>BI Desc</label>
                                                            <span class="error-text BMATHBiDesc_error text-danger" style='float:right;'></span>
                                                            <input type="text" name='BMATHBiDesc' id='BMATHBiDesc' 
                                                ...
                                                <div class="tab-pane fade" id="animated-underline-profile" role="tabpanel" 
                                                    ...
                                                    <div class="media">
                                                        <div class="media-body">
                                                            <div class="form-group">
                                                                <label> User</label>
                                                                <input type="text" name="BMATHUser" id="BMATHUser" 
                                                                class="form-control col-sm-6" readonly/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label> Created Date</label>
                                                                <input type="date" name="BMATHLastCreated" id="BMATHLastCreated" 
                                                                class="form-control col-sm-6" readonly/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label> Updated Date</label>
                                                                <input type="date" name="BMATHLastUpdated" id="BMATHLastUpdated" 
                                                                class="form-control col-sm-6" readonly />
                                                            </div>                                                        
                                                        </div>
                                                    </div>
    ...
    <script>        
        $(document).ready(function(){
            ...
            $('#html5-extension3SIS').DataTable( {
                ...
                serverSide: true,
                // CopyChange                    
                "ajax": "{{ route('acctType.browserData')}}",
                "columns":[
                    // CopyChange
                    {data: "BMATHAcctId"},
                    {data: "BMATHDesc1"},
                    ...
                    {data: "BMATHBiDesc"},
                    {data: "BMATHUser"},
                    {data: "BMATHLastUpdated"},
                    {data: "action", orderable:false, searchable: false},
                    {data: "BMATHUniqueId", "visible": false},
            ...
            $('#add_Data').click(function(){                    
                $("#BMATHAcctId").attr("readonly", false);
            ...
            $(document).on('click', '.edit', function(){
                ...
                $.ajax({
                    // CopyChange
                    url: "{{route('acctType.fetchData')}}",
                    method: 'GET',
                    data: {id:id},
                    dataType: 'json',
                    success: function(data)
                    {                        
                        var lastCreated = formattedDate(new Date(data.BMATHLastCreated));
                        var lastUpdated = formattedDate(new Date(data.BMATHLastUpdated));
                        $('#BMATHUniqueId').val(data.BMATHUniqueId);                       
                        $('#BMATHAcctId').val(data.BMATHAcctId);
                        $('#BMATHDesc1').val(data.BMATHDesc1);
                        $('#BMATHDesc2').val(data.BMATHDesc2);  
                        $('#BMATHBiDesc').val(data.BMATHBiDesc);                        
                        $('#BMATHUser').val(data.BMATHUser);
                        $('#BMATHLastCreated').val(lastCreated);
                        $('#BMATHLastUpdated').val(lastUpdated);
                        $("#BMATHAcctId").attr("readonly", true);                           
            ...
            $(document).on('click', '.delete', function(){
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        $deleteMessage3SIS = fnSingleLevelDeleteConfirmation($modalTitle, data.BMATHAcctId, '');   
            ...
            $('#Undelete_Data').click(function(){                    
                ...
                destroy: true,                    
                // CopyChange                    
                "ajax": "{{ route('acctType.browserDeletedRecords')}}",
                "columns":[
                    // CopyChange
                    {data: "BMATHAcctId"},
                    {data: "BMATHDesc1"},
            ...
            $(document).on('click', '.restore', function(){
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        $restoreMessage3SIS = fnSingleLevelRestoreConfirmation($modalTitle, data.BMATHAcctId, '');   
                ...
                $(document).on('click', '.confirmrestore', function(){
                    $.ajax({
                        url:"{{route('acctType.restoreDeletedRecords')}}",
                        mehtod:"get",
                        data:{id:DeletedUniqueId},
                        success:function(data)
                        {                       
