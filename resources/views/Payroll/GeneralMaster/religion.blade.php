                                ...
                                <div class="container-fluid">
                                        <div class="table-responsive">
                                            <table id="html-extension3SIS" class="table table-hover non-hover" style="width:100%">
                                                <thead>
                                                    <tr>                                                                
                                                        <th title="Religion Master">ID</th>
                                                        <th>Religion</th>
                                                        <th>Desc1</th>
                                                        <th>Action</th>
                                                        <th style="visibility: hidden;">Unique Id</th>
                ...
                <div class="modal-dialog modal-dialog-centered 3SISPro-modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form id="singleLevelDataEntryForm" autocomplete="off" 
                            method="post" action="{{ route('religionMaster.postData') }}">
                                        ...
                                        <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" 
                                            ...
                                            <div class="container-fluid">
                                                <div class="form-group">
                                                    <input type="hidden" name="GMRLHUniqueId" id="GMRLHUniqueId" class="form-control" />
                                                </div>
                                                <div class="row mt-0">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Religion Id</label>
                                                            <span class="error-text GMRLHReligionId_error text-danger" style="float: right;"></span>
                                                            <input type="text" name="GMRLHReligionId" id="GMRLHReligionId" class="form-control few-options" maxlength="10" placeholder="Religion Id" style="opacity: 1;" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Description</label>
                                                            <span class="error-text GMRLHDesc1_error text-danger" style="float: right;"></span>
                                                            <input type="text" name="GMRLHDesc1" id="GMRLHDesc1" class="form-control few-options" maxlength="100" placeholder="Religion Description" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Description2</label>
                                                    <span class="error-text GMRLHDesc2_error text-danger" style="float: right;"></span>
                                                    <textarea
                                                        name="GMRLHDesc2"
                                                        id="GMRLHDesc2"
                                                        ...
                                                        name="alloptions"
                                                        id="alloptions1"
                                                        placeholder="Religion Description2"
                                                ...
                                                <div class="form-group">
                                                    <label>BI Desc</label>
                                                    <span class="error-text GMRLHBiDesc_error text-danger" style="float: right;"></span>
                                                    <input type="text" name="GMRLHBiDesc" id="GMRLHBiDesc" class="form-control few-options" maxlength="100" placeholder="BI Description" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="animated-underline-profile" role="tabpanel" 
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    <div class="form-group">
                                                        <label> User</label>
                                                        <input type="text" name="GMRLHUser" id="GMRLHUser" 
                                                        class="form-control col-sm-6" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label> Created Date</label>
                                                        <input type="date" name="GMRLHLastCreated" id="GMRLHLastCreated" 
                                                        class="form-control col-sm-6" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label> Updated Date</label>
                                                        <input type="date" name="GMRLHLastUpdated" id="GMRLHLastUpdated" 
                                                        class="form-control col-sm-6" readonly />
                                                    </div>                                                        
                                                </div>
                                            </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#html5-extension3SIS').DataTable( {
            ...
            processing: true,
            serverSide: true,                
            "ajax": "{{ route('religionMaster.browserData')}}",        
            "columns":[                    
                {data: "GMRLHReligionId"},
                {data: "GMRLHDesc1"},
                {data: "GMRLHDesc2"},                
                {data: "action", orderable:false, searchable: false},
                {data: "GMRLHUser", "visible": false},
                {data: "GMRLHLastUpdated", "visible": false},
                {data: "GMRLHUniqueId", "visible": false},
            ],
            "columnDefs": [
                { "width": "10%", "targets": 0 },
                { "width": "25%", "targets": 1 },
        ...
        $('#add_Data').click(function(){                    
            $("#GMRLHReligionId").attr("readonly", false);                
        ...
        $(document).on('click', '.edit', function(){
            var id = $(this).attr('id');
            $.ajax({
                url: "{{route('religionMaster.fetchData')}}",
                method: 'GET',
                data: {id:id},
                dataType: 'json',
                success: function(data)
                {
                    var lastCreated = formattedDate(new Date(data.GMRLHLastCreated));
                    var lastUpdated = formattedDate(new Date(data.GMRLHLastUpdated));
                    $('#GMRLHUniqueId').val(data.GMRLHUniqueId);
                    $('#GMRLHReligionId').val(data.GMRLHReligionId);
                    $('#GMRLHDesc1').val(data.GMRLHDesc1);
                    $('#GMRLHDesc2').val(data.GMRLHDesc2);
                    $('#GMRLHBiDesc').val(data.GMRLHBiDesc);
                    $('#GMRLHUser').val(data.GMRLHUser);
                    $('#GMRLHLastCreated').val(lastCreated);
                    $('#GMRLHLastUpdated').val(lastUpdated);
                    $("#GMRLHReligionId").attr("readonly", true);                       
        ...
        $(document).on('click', '.delete', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $deleteMessage3SIS = fnSingleLevelDeleteConfirmation($modalTitle, data.GMRLHReligionId, data.GMRLHDesc1);   
            ...
            $(document).on('click', '.confirm', function(){
                $.ajax({
                    url:"{{route('religionMaster.deleteData')}}",
                    mehtod:"get",
                    data:{id:UniqueId},
                    success:function(data)
                    {
        ...
        $('#Undelete_Data').click(function(){                    
            ...
            destroy: true,                    
            // CopyChange                    
            "ajax": "{{ route('religionMaster.browserDeletedRecords')}}",
                "columns":[
                    // CopyChange
                    {data: "GMRLHReligionId"},
                    {data: "GMRLHDesc1"},
        ...
        $(document).on('click', '.restore', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $restoreMessage3SIS = fnSingleLevelRestoreConfirmation($modalTitle, data.GMRLHReligionId, '');   
            ...
            $(document).on('click', '.confirmrestore', function(){
                $.ajax({
                    url:"{{route('religionMaster.restoreDeletedRecords')}}",
                    mehtod:"get",
                    data:{id:DeletedUniqueId},
                    success:function(data)
                    {                       
