                                ...
                                <div class="container-fluid">
                                        <div class="table-responsive">
                                            <table id="html-extension3SIS" class="table table-hover non-hover" style="width:100%">
                                                <thead>
                                                    <tr>                                                                
                                                        <th title="Nationality Master">ID</th>
                                                        <th>Nationality</th>
                                                        <th>Desc1</th>
                                                        <th>Action</th>
                                                        <th style="visibility: hidden;">Unique Id</th>
                ...
                <div class="modal-dialog modal-dialog-centered 3SISPro-modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form id="singleLevelDataEntryForm" autocomplete="off" 
                            method="post" action="{{ route('nationality.postData') }}">
                                        ...
                                        <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" 
                                            ...
                                            <div class="container-fluid">
                                                <div class="form-group">
                                                    <input type="hidden" name="GMNAHUniqueId" id="GMNAHUniqueId" class="form-control" />
                                                </div>
                                                <div class="row mt-0">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Nationality Id</label>
                                                            <span class="error-text GMNAHNationalityId_error text-danger" style="float: right;"></span>
                                                            <input type="text" name="GMNAHNationalityId" id="GMNAHNationalityId" class="form-control few-options" maxlength="10" placeholder="Nationality Id" style="opacity: 1;" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Description</label>
                                                            <span class="error-text GMNAHDesc1_error text-danger" style="float: right;"></span>
                                                            <input type="text" name="GMNAHDesc1" id="GMNAHDesc1" class="form-control few-options" maxlength="100" placeholder="Nationality Description" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Description2</label>
                                                    <span class="error-text GMNAHDesc2_error text-danger" style="float: right;"></span>
                                                    <textarea
                                                        name="GMNAHDesc2"
                                                        id="GMNAHDesc2"
                                                        ...
                                                        name="alloptions"
                                                        id="alloptions1"
                                                        placeholder="Nationality Description2"
                                                ...
                                                <div class="form-group">
                                                    <label>BI Desc</label>
                                                    <span class="error-text GMNAHBiDesc_error text-danger" style="float: right;"></span>
                                                    <input type="text" name="GMNAHBiDesc" id="GMNAHBiDesc" class="form-control few-options" maxlength="100" placeholder="BI Description" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="animated-underline-profile" role="tabpanel" 
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    <div class="form-group">
                                                        <label> User</label>
                                                        <input type="text" name="GMNAHUser" id="GMNAHUser" 
                                                        class="form-control col-sm-6" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label> Created Date</label>
                                                        <input type="date" name="GMNAHLastCreated" id="GMNAHLastCreated" 
                                                        class="form-control col-sm-6" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label> Updated Date</label>
                                                        <input type="date" name="GMNAHLastUpdated" id="GMNAHLastUpdated" 
                                                        class="form-control col-sm-6" readonly />
                                                    </div>                                                        
                                                </div>
                                            </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#html5-extension3SIS').DataTable( {
            ...
            processing: true,
            serverSide: true,                
            "ajax": "{{ route('nationality.browserData')}}",        
            "columns":[                    
                {data: "GMNAHNationalityId"},
                {data: "GMNAHDesc1"},
                {data: "GMNAHDesc2"},                
                {data: "action", orderable:false, searchable: false},
                {data: "GMNAHUser", "visible": false},
                {data: "GMNAHLastUpdated", "visible": false},
                {data: "GMNAHUniqueId", "visible": false},
            ],
            "columnDefs": [
                { "width": "10%", "targets": 0 },
                { "width": "25%", "targets": 1 },
        ...
        $('#add_Data').click(function(){                    
            $("#GMNAHNationalityId").attr("readonly", false);                
        ...
        $(document).on('click', '.edit', function(){
            var id = $(this).attr('id');
            $.ajax({
                url: "{{route('nationality.fetchData')}}",
                method: 'GET',
                data: {id:id},
                dataType: 'json',
                success: function(data)
                {
                    var lastCreated = formattedDate(new Date(data.GMNAHLastCreated));
                    var lastUpdated = formattedDate(new Date(data.GMNAHLastUpdated));
                    $('#GMNAHUniqueId').val(data.GMNAHUniqueId);
                    $('#GMNAHNationalityId').val(data.GMNAHNationalityId);
                    $('#GMNAHDesc1').val(data.GMNAHDesc1);
                    $('#GMNAHDesc2').val(data.GMNAHDesc2);
                    $('#GMNAHBiDesc').val(data.GMNAHBiDesc);
                    $('#GMNAHUser').val(data.GMNAHUser);
                    $('#GMNAHLastCreated').val(lastCreated);
                    $('#GMNAHLastUpdated').val(lastUpdated);
                    $("#GMNAHNationalityId").attr("readonly", true);                       
        ...
        $(document).on('click', '.delete', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $deleteMessage3SIS = fnSingleLevelDeleteConfirmation($modalTitle, data.GMNAHNationalityId, data.GMNAHDesc1);   
            ...
            $(document).on('click', '.confirm', function(){
                $.ajax({
                    url:"{{route('nationality.deleteData')}}",
                    mehtod:"get",
                    data:{id:UniqueId},
                    success:function(data)
                    {
        ...
        $('#Undelete_Data').click(function(){                    
            ...
            destroy: true,                    
            // CopyChange                    
            "ajax": "{{ route('nationality.browserDeletedRecords')}}",
                "columns":[
                    // CopyChange
                    {data: "GMNAHNationalityId"},
                    {data: "GMNAHDesc1"},
        ...
        $(document).on('click', '.restore', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $restoreMessage3SIS = fnSingleLevelRestoreConfirmation($modalTitle, data.GMNAHNationalityId, '');   
            ...
            $(document).on('click', '.confirmrestore', function(){
                $.ajax({
                    url:"{{route('nationality.restoreDeletedRecords')}}",
                    mehtod:"get",
                    data:{id:DeletedUniqueId},
                    success:function(data)
                    {                       
