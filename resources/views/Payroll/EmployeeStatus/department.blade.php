                                        ...
                                        <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" 
                                            ...
                                            <div class="container-fluid">
                                                <div class="form-group">
                                                    <input type="hidden" name="ESDPHUniqueId" id="ESDPHUniqueId" class="form-control" />
                                                </div>
                                                <div class="row mt-0">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="ESDPHDepartmentId" id="ESDPHDepartmentId" class="form-control few-options" maxlength="10" placeholder="Department Id" style="opacity: 1;" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="ESDPHDesc1" id="ESDPHDesc1" class="form-control few-options" maxlength="100" placeholder="Department Description" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <textarea
                                                        ...
                                                        name="alloptions"
                                                        id="alloptions1"
                                                        placeholder="Department Description2"
