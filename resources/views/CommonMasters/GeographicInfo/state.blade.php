                    ...
                    <div class="modal-dialog modal-dialog-centered 3SISPro-modal-dialog modal-lg" role="document">
                        <div class='modal-content'>                              
                            ...
                            <form  id='singleLevelDataEntryForm' autocomplete="off"
                                    method="post" action="{{ route('state.postData') }}">
                                            ...
                                            <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" 
                                                ...
                                                <div class="container-fluid">
                                                    ...
                                                    <div class='form-group mb-0'>
                                                        <input type="hidden" name='GMSMHUniqueId' id='GMSMHUniqueId' 
                                                            class='form-control'>                                                  
                                                    </div>
                                                    <!-- CopyChange -->
                                                    <div class="row mt-0">
                                                        <div class="col-md-6">
                                                            <div class='form-group'>                                                
                                                                ...
                                                                <input type="text"  name='GMSMHStateId' id='GMSMHStateId' 
                                                                    ...
                                                                    placeholder="State Id" style='opacity:1'>
                                                            </div>
                                                        </div>
                                                        <!-- CopyChange -->
                                                        <div class="col-md-6">
                                                            <div class='form-group'>                                                
                                                                ...
                                                                <span class="error-text GMSMHDesc1_error text-danger" 
                                                                    style='float:right;'></span>
                                                                <input type="text" name='GMSMHDesc1' id="GMSMHDesc1"  maxlength="100"
                                                    ...
                                                    <div class="row mt-0">
                                                        <div class="col-md-6">
                                                            <div class='form-group'>                                                
                                                                ...
                                                                <textarea name='GMSMHDesc2' id='GMSMHDesc2' class='form-control few-options' 
                                                                maxlength="200" name="alloptions" id="alloptions1" placeholder="State Description2" 
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class='form-group '>
                                                                <label>BI Desc</label>
                                                                <span class="error-text GMSMHBiDesc_error text-danger" style='float:right;'></span>
                                                                <input type="text" name='GMSMHBiDesc' id='GMSMHBiDesc' 
                                                    ...
                                                    <div class='form-group'>
                                                        ...
                                                        <span class="error-text countryId_error text-danger" 
                                                            style='float:right;'></span>
                                            ...
                                            <div class="tab-pane fade" id="animated-underline-profile" role="tabpanel" 
                                                ...
                                                <div class="media">
                                                    <div class="media-body">
                                                        <div class="form-group">
                                                            <label> User</label>
                                                            <input type="text" name="GMSMHUser" id="GMSMHUser" 
                                                            class="form-control col-sm-6" readonly/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label> Created Date</label>
                                                            <input type="date" name="GMSMHLastCreated" id="GMSMHLastCreated" 
                                                            class="form-control col-sm-6" readonly/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label> Updated Date</label>
                                                            <input type="date" name="GMSMHLastUpdated" id="GMSMHLastUpdated" 
                                                            class="form-control col-sm-6" readonly />
                                                        </div>                                                        
                                                    </div>
                                                </div>
    ...
    $(document).ready(function(){
        ...
        $('#html5-extension3SIS').DataTable( {
            ...
            "columns":[
                ...
                {data: "GMCMHDesc1"},
                {data: "GMSMHUser"},
                {data: "GMSMHLastUpdated"},
                {data: "action", orderable:false, searchable: false},
                {data: "GMSMHDesc2", "visible": false},
                {data: "GMSMHBiDesc", "visible": false},
                {data: "GMSMHUniqueId", "visible": false},
        ...
        $('#add_Data').click(function(){                    
            $("#GMSMHStateId").attr("readonly", false);
        ...
        $(document).on('click', '.edit', function(){
            ...
            $.ajax({
                // CopyChange
                url: "{{route('state.fetchData')}}",
                method: 'GET',
                data: {id:id},
                dataType: 'json',
                success: function(data)
                { 
                    var lastCreated = formattedDate(new Date(data.GMSMHLastCreated));
                    var lastUpdated = formattedDate(new Date(data.GMSMHLastUpdated));
                    $('#GMSMHUniqueId').val(data.GMSMHUniqueId);                       
                    $('#GMSMHStateId').val(data.GMSMHStateId);
                    $('#GMSMHDesc1').val(data.GMSMHDesc1);
                    $('#GMSMHDesc2').val(data.GMSMHDesc2);  
                    $('#GMSMHBiDesc').val(data.GMSMHBiDesc);                        
                    $('#GMSMHUser').val(data.GMSMHUser);                        
                    $('#GMSMHLastCreated').val(lastCreated);                        
                    $('#GMSMHLastUpdated').val(lastUpdated);                         
                    /* Ajax Call for selected element to show in drop down */
                    var countrySelect = $('#countryId');
                    var id = data.GMSMHCountryId;
                    $.ajax({
                    ...
                    $("#GMSMHStateId").attr("readonly", true);                           
        ...
        $(document).on('click', '.delete', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $deleteMessage3SIS = fnSingleLevelDeleteConfirmation($modalTitle, data.GMSMHStateId, '');   
        ...
        $('#Undelete_Data').click(function(){                    
            ...
            destroy: true,                    
            // CopyChange                    
            "ajax": "{{ route('state.browserDeletedRecords')}}",
            "columns":[
                // CopyChange
                {data: "GMSMHStateId"},
                {data: "GMSMHDesc1"},
        ...
        $(document).on('click', '.restore', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $restoreMessage3SIS = fnSingleLevelRestoreConfirmation($modalTitle, data.GMSMHStateId, '');   
            ...
            $(document).on('click', '.confirmrestore', function(){
                $.ajax({
                    url:"{{route('state.restoreDeletedRecords')}}",
                    mehtod:"get",
                    data:{id:DeletedUniqueId},
                    success:function(data)
                    {                       
