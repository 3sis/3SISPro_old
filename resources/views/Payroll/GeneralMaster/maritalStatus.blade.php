                                ...
                                <div class="container-fluid">
                                        <div class="table-responsive">
                                            <table id="html-extension3SIS" class="table table-hover non-hover" style="width:100%">
                                                <thead>
                                                    <tr>                                                                
                                                        <th title="MaritalStatus Master">ID</th>
                                                        <th>Marital Status</th>
                                                        <th>Desc1</th>
                                                        <th>Action</th>
                                                        <th style="visibility: hidden;">Unique Id</th>
                ...
                <div class="modal-dialog modal-dialog-centered 3SISPro-modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form id="singleLevelDataEntryForm" autocomplete="off" 
                            method="post" action="{{ route('maritalStatus.postData') }}">
                                        ...
                                        <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" 
                                            ...
                                            <div class="container-fluid">
                                                <div class="form-group">
                                                    <input type="hidden" name="GMMSHUniqueId" id="GMMSHUniqueId" class="form-control" />
                                                </div>
                                                <div class="row mt-0">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>MaritalStatus Id</label>
                                                            <span class="error-text GMMSHMaritalStatusId_error text-danger" style="float: right;"></span>
                                                            <input type="text" name="GMMSHMaritalStatusId" id="GMMSHMaritalStatusId" class="form-control few-options" maxlength="10" placeholder="MaritalStatus Id" style="opacity: 1;" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Description</label>
                                                            <span class="error-text GMMSHDesc1_error text-danger" style="float: right;"></span>
                                                            <input type="text" name="GMMSHDesc1" id="GMMSHDesc1" class="form-control few-options" maxlength="100" placeholder="MaritalStatus Description" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Description2</label>
                                                    <span class="error-text GMMSHDesc2_error text-danger" style="float: right;"></span>
                                                    <textarea
                                                        name="GMMSHDesc2"
                                                        id="GMMSHDesc2"
                                                        ...
                                                        name="alloptions"
                                                        id="alloptions1"
                                                        placeholder="MaritalStatus Description2"
                                                ...
                                                <div class="form-group">
                                                    <label>BI Desc</label>
                                                    <span class="error-text GMMSHBiDesc_error text-danger" style="float: right;"></span>
                                                    <input type="text" name="GMMSHBiDesc" id="GMMSHBiDesc" class="form-control few-options" maxlength="100" placeholder="BI Description" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="animated-underline-profile" role="tabpanel" 
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    <div class="form-group">
                                                        <label> User</label>
                                                        <input type="text" name="GMMSHUser" id="GMMSHUser" 
                                                        class="form-control col-sm-6" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label> Created Date</label>
                                                        <input type="date" name="GMMSHLastCreated" id="GMMSHLastCreated" 
                                                        class="form-control col-sm-6" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label> Updated Date</label>
                                                        <input type="date" name="GMMSHLastUpdated" id="GMMSHLastUpdated" 
                                                        class="form-control col-sm-6" readonly />
                                                    </div>                                                        
                                                </div>
                                            </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#html5-extension3SIS').DataTable( {
            ...
            processing: true,
            serverSide: true,                
            "ajax": "{{ route('maritalStatus.browserData')}}",        
            "columns":[                    
                {data: "GMMSHMaritalStatusId"},
                {data: "GMMSHDesc1"},
                {data: "GMMSHDesc2"},                
                {data: "action", orderable:false, searchable: false},
                {data: "GMMSHUser", "visible": false},
                {data: "GMMSHLastUpdated", "visible": false},
                {data: "GMMSHUniqueId", "visible": false},
            ],
            "columnDefs": [
                { "width": "10%", "targets": 0 },
                { "width": "25%", "targets": 1 },
        ...
        $('#add_Data').click(function(){                    
            $("#GMMSHMaritalStatusId").attr("readonly", false);                
        ...
        $(document).on('click', '.edit', function(){
            var id = $(this).attr('id');
            $.ajax({
                url: "{{route('maritalStatus.fetchData')}}",
                method: 'GET',
                data: {id:id},
                dataType: 'json',
                success: function(data)
                {
                    var lastCreated = formattedDate(new Date(data.GMMSHLastCreated));
                    var lastUpdated = formattedDate(new Date(data.GMMSHLastUpdated));
                    $('#GMMSHUniqueId').val(data.GMMSHUniqueId);
                    $('#GMMSHMaritalStatusId').val(data.GMMSHMaritalStatusId);
                    $('#GMMSHDesc1').val(data.GMMSHDesc1);
                    $('#GMMSHDesc2').val(data.GMMSHDesc2);
                    $('#GMMSHBiDesc').val(data.GMMSHBiDesc);
                    $('#GMMSHUser').val(data.GMMSHUser);
                    $('#GMMSHLastCreated').val(lastCreated);
                    $('#GMMSHLastUpdated').val(lastUpdated);
                    $("#GMMSHMaritalStatusId").attr("readonly", true);                       
        ...
        $(document).on('click', '.delete', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $deleteMessage3SIS = fnSingleLevelDeleteConfirmation($modalTitle, data.GMMSHMaritalStatusId, data.GMMSHDesc1);   
            ...
            $(document).on('click', '.confirm', function(){
                $.ajax({
                    url:"{{route('maritalStatus.deleteData')}}",
                    mehtod:"get",
                    data:{id:UniqueId},
                    success:function(data)
                    {
        ...
        $('#Undelete_Data').click(function(){                    
            ...
            destroy: true,                    
            // CopyChange                    
            "ajax": "{{ route('maritalStatus.browserDeletedRecords')}}",
                "columns":[
                    // CopyChange
                    {data: "GMMSHMaritalStatusId"},
                    {data: "GMMSHDesc1"},
        ...
        $(document).on('click', '.restore', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    $restoreMessage3SIS = fnSingleLevelRestoreConfirmation($modalTitle, data.GMMSHMaritalStatusId, '');   
            ...
            $(document).on('click', '.confirmrestore', function(){
                $.ajax({
                    url:"{{route('maritalStatus.restoreDeletedRecords')}}",
                    mehtod:"get",
                    data:{id:DeletedUniqueId},
                    success:function(data)
                    {                       
